...
class LineNotifyService
  ...
  TOKEN = '0Ga2CHkIUOrzbppA7AV1CokKSVq6nmeywFSeDxVvzgI'.freeze
  ...
  def msg(task)
    message = <<-TEXT
        ...
        ・キャンセルURL
          #{"http://localhost:3000/calendars/#{calendar.public_uid}/tasks/#{task.id}/cancel" if Rails.env == 'development'}
        ===================
    TEXT
  end
end
